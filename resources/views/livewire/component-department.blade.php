<div class="mt-2">
                ...
                @foreach ($departments as $department)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                <li>
                                    <a wire:click='showForm({{ $department->id }})'
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $department->id }})'
    ...
    <flux:modal name="department-form" class="md:w-120">
        <div class="space-y-6">
            <div>
                @if ($activity == 'create')
    ...
    <flux:modal name="department-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
