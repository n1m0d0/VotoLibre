<div class="mt-2">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $zone->id }})'
    ...
    <flux:modal name="zone-form" class="md:w-120">
        <div class="space-y-6">
            <div>
                @if ($activity == 'create')
    ...
    <flux:modal name="zone-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">{{ __('Delete zone') }}</flux:heading>
