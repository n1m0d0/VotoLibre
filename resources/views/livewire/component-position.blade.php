<div class="mt-2">
                ...
                @foreach ($positions as $position)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                <li>
                                    <a wire:click='showForm({{ $position->id }})'
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $position->id }})'
    ...
    <flux:modal name="position-form" class="md:w-120">
        <div class="space-y-6">
            <div>
                @if ($activity == 'create')
                    <flux:heading size="lg">{{ __('Create position') }}</flux:heading>
                @else
    ...
    <flux:modal name="position-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
