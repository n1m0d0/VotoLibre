<div class="mt-2">
                ...
                @foreach ($districts as $district)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <ul>
                                <li>
                                    <a wire:click='showForm({{ $district->id }})'
                                ...
                                <li>
                                    <a wire:click='showDelete({{ $district->id }})'
    ...
    <flux:modal name="district-form" class="md:w-120">
        <div class="space-y-6">
            <div>
                @if ($activity == 'create')
                    <flux:heading size="lg">{{ __('Create district') }}</flux:heading>
                @else
                    <flux:heading size="lg">{{ __('Edit district') }}</flux:heading>
                @endif
            </div>

            <flux:label>{{ __('Municipality') }}</flux:label>

            <flux:select class="mt-2" wire:model="form.municipality">
            ...
            <flux:error name="form.municipality" />
    ...
    <flux:modal name="district-delete" class="md:w-120">
        <div class="space-y-6">
            <div>
